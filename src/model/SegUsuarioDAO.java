...
public class SegUsuarioDAO extends ClaseDAO{
	...
	@SuppressWarnings("unchecked")
	public List<SegUsuario> getRecuperaSoloComuneros(String value){
		List<SegUsuario> retorno = new ArrayList<SegUsuario>();
		
				//Hacer el Query
		Query query = getEntityManager().createNamedQuery("SegUsuario.buscarSoloComuneros").setParameter("patron", value);
	...
	@SuppressWarnings("unchecked")
	public List<SegUsuario> getRecuperaSoloClientes(String value){
		List<SegUsuario> retorno = new ArrayList<SegUsuario>();
		
				//Hacer el Query
		Query query = getEntityManager().createNamedQuery("SegUsuario.buscarSoloClientes").setParameter("patron", value);
	...
	@SuppressWarnings("unchecked")
	public List<SegUsuario> getListaUbicaciones(){
		List<SegUsuario> retorno = new ArrayList<SegUsuario>();
		
				//Hacer el Query
		Query query = getEntityManager().createNamedQuery("SegUsuario.buscarDireccionesMapa");
	...
	@SuppressWarnings("unchecked")
	public List<SegUsuario> getComunerosBuscaHistorial(String value){
		List<SegUsuario> retorno = new ArrayList<SegUsuario>();
		...
		//Hacer el Query
		Query query = getEntityManager().createNamedQuery("SegUsuario.buscarSoloComunerosCedula").setParameter("patron", value);
