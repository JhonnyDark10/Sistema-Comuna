...
public class Ctrl_ListaCuentas extends SelectorComposer{
	...
	private SegUsuario cuentaSelecionada;
	...
	public void buscar(){
		...
		Usuarios = usuarioDao.getTodos(txtBuscar.getValue());
	...
	public void nuevo(){
		...
		Window ventanaCargar = (Window)Executions.createComponents("/A_ModuloSeguridad/Cuentas.zul", winListaCuentas,params);
	...
	public SegUsuario getCuentaSelecionada() {
		return cuentaSelecionada;
	}


	public void setCuentaSelecionada(SegUsuario cuentaSelecionada) {
